...
<sf:form name="form1" method="post" id="form1" modelAttribute="TQuesPoint">
    ...
    <div class="navigation"><a href="javascript:history.go(-1);" class="back">后退</a>首页 &gt; <a
            href="/point/points">知识点管理</a> &gt; <a href="#">增加知识点</a></div>
    <table class="form_table">
        ...
        <tr>
            ...
            <td>
                ...
                <select onchange="bankChange()" id="selQuesBank" class="select2 required">
                    <option>==请选择题库集==</option>
                    ...
                    <%----%>
                    <%--</c:forEach>--%>
                    <%--<s:select onchange="bankChange()"  id="selQuesBank"  list="#banks" listKey="id" listValue="bankName" name="bankId"  headerKey="-1" headerValue="==请选题库集=="  class="select2 required"/>--%>
            </td>
        </tr>
        <tr>
            <th>题库：</th>
        ...
        <tr>
            <th>知识点名称：</th>
            <td><sf:input path="pointName" maxlength="100" id="txtPointName" class="txtInput normal required"/>
            </td>
        </tr>
    </table>
