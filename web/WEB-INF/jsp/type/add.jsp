...
<body class="mainbody">
<sf:form name="form1" method="post" id="form1" modelAttribute="TQuesType">

    <div class="navigation"><a href="javascript:history.go(-1);" class="back">后退</a>首页 &gt; <a
            href="/type/types">题型管理</a> &gt; <a href="#">增加题型</a></div>
    <table class="form_table">
        ...
        <tr>
            <th>题型：</th>
            <td>
                <sf:input path="typeName" maxlength="100" id="txtTitle" class="txtInput normal required"/>
            </td>
        </tr>
    </table>
