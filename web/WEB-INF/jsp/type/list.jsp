...
<body class="mainbody">
    <div class="navigation">首页 &gt; 题目资源管理 &gt; 题型管理</div>
    <div class="tools_box">
        <div class="tools_bar">
            <a href="javascript:void(0);" onclick="checkAll(this);" class="tools_btn"><span><b class="all">全选</b></span></a>
            <a href="/type/add" class="tools_btn"><span><b class="import">添加题型</b></span></a>
            <a href="/type/types" class="tools_btn"><span><b class="refresh">刷新信息</b></span></a>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
        ...
        <c:forEach items="${types}" var="t">
            <tr>
                <td align="center"><span class="checkall"><input id="${t.id}" type="checkbox"  /></span></td>
                <td align="center">${t.typeName} </td>
                <td align="center">${t.TQueses.size()}</td>

                <td align="center"><a href="${t.id}/update">修改</a> </td>
                <td align="center"><a href="${t.id}/delete">删除</a></td>
            </tr>
        </c:forEach>
    </table>
