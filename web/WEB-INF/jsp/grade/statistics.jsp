...
<div class="navigation"><a href="javascript:history.go(-1);" class="back">后退</a>首页 &gt; <a
        href="/exam/exams">考试管理</a> &gt; <a href="#">详细信息</a></div>
...
<div class="nlist2 clearfix">
    ...
    <ul>
        ...
        <%--<li>移出限制：${exam.moveouttimes==-1?'不限次数':(exam.moveouttimes+' 次')}</li>--%>
        <li>移出限制：
            <c:choose>
        ...
        <li>显示方式：
            ...
            <%--${exam.showtype==2 ? '一屏一题':(exam.showtype == 1? '一屏一题型':'一屏所有题')}</li>--%>
        <li>考试规模：${exam.ispartuser==1?'部分员工':'全部员工'}</li>
    </ul>
    ...
    <%--<div class="foot_btn_box">--%>
        <%--<a href="examusers"> <input type="button" value="增删考生" id="btnmodeusers" class="btnSubmit"/></a>--%>
        <%--&nbsp;<a href="examhandle"><input type="button" value="处理批阅" id="btnExamhandle" class="btnSubmit"/></a>--%>
