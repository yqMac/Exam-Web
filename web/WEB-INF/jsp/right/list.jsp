...
<body class="mainbody">
    <div class="navigation">首页 &gt; 人员信息管理 &gt; 权限管理</div>
    <div class="tools_box">
        <div class="tools_bar">
            <a href="javascript:void(0);" onclick="checkAll(this);" class="tools_btn"><span><b class="all">全选</b></span></a>
            <a href="/right/add" class="tools_btn"><span><b class="import">添加权限</b></span></a>
            <a href="/right/rights" class="tools_btn"><span><b class="refresh">刷新信息</b></span></a>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
        ...
        <c:forEach items="${rights}" var="r">
            <tr>
                ...
                <td align="center">${r.rightName}</td>
                <td align="center">${r.parent.rightName}</td>
                <td align="center">${r.rightUrl}</td>
                <td align="center"><a href="/right/${r.id}/update">修改</a> </td>
                <td align="center"><a href="/right/${r.id}/delete">删除</a></td>
            </tr>
        </c:forEach>
    </table>
