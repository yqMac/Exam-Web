...
<body class="mainbody">
    <div class="navigation">首页 &gt; 基本权限 &gt; 可参与考试</div>
    <div class="tools_box">
        <div class="tools_bar">
            <a href="javascript:void(0);" onclick="checkAll(this);" class="tools_btn"><span><b class="all">全选</b></span></a>
            <%--<a href="exam_addPre" class="tools_btn"><span><b class="import">全员考试</b></span></a>--%>
            <a href="/userexam/exams" class="tools_btn"><span><b class="refresh">刷新信息</b></span></a>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
        ...
        <c:forEach items="${exams}" var="exam">
            <tr>
                ...
                <td align="center">${exam.ispartuser==1?'部分用户':'全部用户'} </td>
                <td align="center"><a href="${exam.id}/detail">详细信息</a></td>
        ...
        <%--<tr>--%>
            ...
            <%--<td align="center"><s:property value="ispartuser==1?'部分用户':'全部用户'"/> </td>--%>
