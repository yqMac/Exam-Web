...
<div class="navigation">首页 &gt; 题目资源管理 &gt; 题库管理</div>
<div class="tools_box">
    <div class="tools_bar">
        <a href="javascript:void(0);" onclick="checkAll(this);" class="tools_btn"><span><b class="all">全选</b></span></a>
        <a href="/lib/add" class="tools_btn"><span><b class="import">添加题库</b></span></a>
        <a href="/lib/libs" class="tools_btn"><span><b class="refresh">刷新信息</b></span></a>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
    ...
    <c:forEach items="${libs}" var="b">
        <tr>
            <td align="center"><span class="checkall"><input id="${b.id}" type="checkbox"/></span></td>
            <td align="center">${b.libName} </td>
            <td align="center">${b.TQueses.size()}</td>
            <td align="center">${b.TQuesBank.getBankName()}</td>
