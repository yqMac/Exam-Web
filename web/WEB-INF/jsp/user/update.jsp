...
<sf:form name="form1" method="post"  id="form1"  modelAttribute="TUser">
    ...
    <div class="navigation"><a href="javascript:history.go(-1);" class="back">后退</a>首页 &gt; <a
            href="/user/users">人员管理</a> &gt; <a href="#">修改人员</a></div>
    <sf:hidden path="id"/>
    <table class="form_table">
        ...
        <tr>
            <th>用户组：</th>
            <td>
                <sf:select path="TClass.id" items="${classs}" itemLabel="className" itemValue="id"  id="drpArticleType" class="select2 required"/>
                <%--<s:select name="classId" list="#classs" listKey="id" listValue="className" headerKey="-1"--%>
                          <%--headerValue="==请选择=="/>--%>
            </td>
        </tr>
        <tr>
            <th>角色：</th>
            <td>
                <sf:select path="TRole.id" items="${roles}" itemLabel="roleName" itemValue="id"  id="drpArticleType" class="select2 required" />
                <%--<s:select name="roleId" list="#roles" listKey="id" listValue="roleName" headerKey="-1"--%>
                          <%--headerValue="==请选择=="/>--%>
            </td>
        </tr>
        <tr>
            <th>帐号：</th>
            <td>
                <sf:input path="username" maxlength="100" class="txtInput normal"/>
        ...
        <tr>
            <th>密码：</th>
            <td>
                <sf:password path="password" showPassword="true" maxlength="100" class="txtInput normal"/>
                <%--<input name="password" type="password" maxlength="100" id="txtPass" class="txtInput normal required" />--%>
            </td>
            <%--<td>--%>
        ...
        <tr>
            <th>昵称：</th>
            <td>
                <sf:input path="nickname" maxlength="100" class="txtInput normal"/>
                <%--<input name="nickname" type="text"  maxlength="100"  class="txtInput normal" />--%>
            </td>
        </tr>
    </table>
