...
<head id="Head1">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function bankChange() {
            ...
            $.ajax({
                type: "Post",
                url: "ajax_getLibOptionHeaderAllByBankId",
                data: "bankId=" + bId,
        ...
        function libChange() {
            ...
            $.ajax({
                type: "Post",
                url: "ajax_getPointOptionHeaderAllByLibId",
                data: "libId=" + bId,
                success: function (msg) {
                    if ($.trim(msg) != "") {
        ...
        function PolicyAdd() {
            ...
            $.ajax({
                ...
                url: "ajax_getTypeQuesJsonByBLPTs",
                //地址栏传值
                //题库集 题库 知识点 难度 题型
    ...
    <script type="text/javascript">
        $(function () {
            //考题随机设置
            var val_order = document.getElementById('val_isorder_update').value;
            var show_order = document.getElementById("show_isorder_update");
            if (val_order == 1) {
                show_order.checked = true;
            } else {
                show_order.checked = false;
            }
...
<form name="form1" method="post" action="exam_update"
      onsubmit="return WebForm_OnSubmit();">
    <div class="navigation" align="left" style="padding-top: 10px;padding-left: 10px;line-height: 28px;"><a
            href="javascript:history.go(-1);" class="back">后退</a>首页 &gt; <a
            href="exam_list">考试管理</a> &gt; <a href="#">增加考试</a>
    </div>
                    ...
                    <td>
                        ...
                        <div class="tabCont">
                                    ...
                                    <table width="100%" border="0" align="center" cellpadding="0"
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="5" style="height: 26px" align="left">
                                                <sf:input path="examName" type="text" id="txtTkClName" class="input"
                                                             style="width:545px;"/>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td width="80">
                                                <s:select list="#{0:'一屏显示所有题目',1:'一屏显示一种题型',2:'一屏显示一道题'}"
                                                          name="showtype" id="ExamMode"
                                                          class="Select"/>
                                            </td>
                            ...
                            <span id="tk_cl_time" class="Radio">
                                ...
                                <script type="text/javascript">
                                    $(function () {
                                        var texttime = document.getElementById('examTime_num');
                                        if (texttime.value == 0) {
                                            texttime.readOnly = true;
                                            texttime.style.backgroundColor = '#EFFFFF';
                                        }
                                    });
                                </script>
                                <s:if test="examTime==0">
                                    <input type="radio" name="examTime1"
                                           onclick="var texttime=document.getElementById('examTime_num');texttime.value='0';texttime.readOnly=true;texttime.style.backgroundColor = '#EFFFFF';"
                                           checked
                                    />考试不计时
                                    <br/>
                                    <input type="radio" name="examTime1"
                                           onclick="var texttime=document.getElementById('examTime_num');texttime.value='60';texttime.readOnly=true;texttime.style.backgroundColor = '#FFFFFF';"
                                    />答题时间
                                </s:if>
                                <s:else>
                                    <input type="radio" name="examTime1"
                                    ...
                                    />答题时间
                                                                ...
                                                                <sf:input path="examTime"
                                                                             id="examTime_num" class="input"
                                                                             onPaste="return false;"
                                                                             style="width:40px;"/> 分钟
                                   <span id="RangeValidator3"
                                         style="color:Red;display:none;">请输入正确的数字</span>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    ...
                                                    <table width="300px" style="display: inline;">
                                                        <tr>
                                                            <td><span class="CheckBox">
                                                                <s:hidden name="isorder" id="val_isorder_update"/>
                                                                <input id="show_isorder_update" type="checkbox"
                                                                       name="isorder1"
                                                                       onchange="var texttime=document.getElementById('val_isorder_update');texttime.value=this.checked?1:0;"/>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <span id="MoveOutTimes" class="Radio">
                                                                       ...
                                                                       <script type="text/javascript">
                                                                           $(function () {
                                                                               var outtimes = document.getElementById('MoveOutTimes_num');
                                                                               if (outtimes.value == 0) {
                                                                                   outtimes.readOnly = true;
                                                                                   outtimes.style.backgroundColor = '#EFFFFF';
                                                                               }
                                                                           });
                                                                       </script>
                                <s:if test="moveouttimes==0">
                                    <input type="radio" name="moveout1"
                                    ...
                                    <br/>
                                    <input type="radio" name="moveout1"
                                           onclick="var texttime=document.getElementById('MoveOutTimes_num');texttime.value='5';texttime.readOnly=true;texttime.style.backgroundColor = '#FFFFFF';"
                                    />移出界面次数超过
                                </s:if>
                                <s:else>
                                    <input type="radio" name="moveout1"
                                    ...
                                    <br/>
                                    <input type="radio" name="moveout1"
                                           onclick="var texttime=document.getElementById('MoveOutTimes_num');texttime.value='60';texttime.readOnly=true;texttime.style.backgroundColor = '#FFFFFF';"
                                           checked
                                    />移出界面次数超过
                                </s:else>
                                  <sf:input path="moveouttimes" id="MoveOutTimes_num"
                                               class="input"
                                               onPaste="return false;"
                                               style="width:40px;"/>
                                    ...
                                    <fieldset style="height: 40px; padding: 0 10px; margin-top: 5px;">
                                        ...
                                        <div>
                                            &nbsp;&nbsp;<span class="CheckBox"><input
                                                ...
                                                for="IsShowFS">考试分数保密</label></span>&nbsp;&nbsp;&nbsp;&nbsp;
                                            <span class="CheckBox">
                                            <s:checkbox name="seepaper" id="AllowSeePaper"/>
                                            <label for="AllowSeePaper">允许考生提交后查看答卷和答案</label>
                                            </span>
                                        </div>
                                    </fieldset>
                                                                    ...
                                                                    <tr>
                                                                        <td colspan="2">
                                                                            <table id="KsSavePaper" class="Radio"
                                                                                ...
                                                                                <script type="text/javascript">
                                                                                    $(function () {
                                                                                        var val_savepaper =${savepaper};
                                                                                        if (val_savepaper == 0) {
                                                                                            document.getElementById("KsSavePaper_0").checked = true;
                                                                                        } else if (val_savepaper == 1) {
                                                                                            document.getElementById("KsSavePaper_0").checked = true;
                                                                                        } else if (val_savepaper == 2) {
                                                                                            document.getElementById("KsSavePaper_0").checked = true;
                                                                                        }
                                                                                    });
                                                                                </script>
                            ...
                            <div id="block2" style="display: none; width: 680px;"
                                                                                ...
                                                                                <tr>
                                                                                    <td colspan="2">
                                                                                        <table id="user_all"
                                                                                            ...
                                                                                            <script type="text/javascript">
                                                                                                $(function () {
                                                                                                    var val_ispartuser =${ispartuser};
                                                                                                    if (val_ispartuser == 1) {
                                                                                                        document.getElementById("user_all_1").checked = true;
                                                                                                    } else {
                                                                                                        document.getElementById("user_all_0").checked = true;
                                                                                                    }
                                                                                                });
                                                                                            </script>
                                                                                            <tr>
                                                                            ...
                                                                            <div style="height: 200px; width: 640px; position: relative; overflow: auto; scrollbar-face-color: #D4D0C8;
                                                                                ...
                                                                                <div>
                                                                                    <table class="tab_table"
                                                                                        ...
                                                                                        <script type="text/javascript">
                                                                                            $(function(){
                                                                                                var tmids = document.getElementById("SelectedTX").value;
                                                                                                var tmarr = tmids.split(",");
                                                                                                var chkname = document.getElementsByName("Tm_tx_ID");
                                                                                                for (i = 0; i < chkname.length; i++) {
                                                                                                    for(j=0;j<tmarr.length;j++){
                                                                                                        if(tmarr[j]==chkname[i].value){
                                                                                        ...
                                                                                        <s:iterator value="#types"
                                                                                                    status="L">
                                                                                            <tr class="<s:if test="#L.Even">tab_trl</s:if><s:else>tab_al</s:else>">
                                                                                                <td align="center"
                                                                                                    style="width:30px;">
                                                                                                    <input
                                                                                                            type="checkbox"
                                                                                                            name="Tm_tx_ID"
                                                                                                            class="CheckBox"
                                                                                                            id='tmtxid_<s:property value="id"/>'
                                ...
                                <div class="helpListLast">
                                    <img src="<%=path%>/html/images/exammanage/Admin/aw_ico.gif"/>&nbsp;选择“在考试控制台中安排考生考试”的试卷，需要在“考试管理”中指定参加考试的学员。
                                </div>
                            </div>
                            <div id="block3" style="display: none; width: 680px;"
                                ...
                                <div class="this_height" style="padding-top: 5px;">
                                    <table height="30" border="0" align="center" cellpadding="0"
                                           cellspacing="0">
                                        <tr>
                                            <td>题库集：&nbsp; <s:select list="#banks"
                                                                     name="bankId" id="selbanks"
                                                                     onchange="bankChange();GetZSDList($('#TKJList').val(),0);"
                                                                     headerKey="-1" headerValue="=请选择=" listKey="id"
                                                                     listValue="bankName" theme="simple"></s:select>
                                                题库：&nbsp;
                                                <select name="libId" id="sellibs" class="Select"
                                                        onchange="libChange();"
                                                        style="width:120px;">
                                                    <option value="-1">请选题库集</option>
                                                </select>
                                                知识点：&nbsp;<select name="pointId" id="selpoints"
                                                                  class="Select" style="width:100px;">
                                                    <option value="-1">请选题库</option>

                                                </select> 难度：&nbsp;<select name="NDList" id="NDList" class="Select">
                                                ...
                                                </select> <s:hidden name="selectedTX" id="SelectedTX"/>
